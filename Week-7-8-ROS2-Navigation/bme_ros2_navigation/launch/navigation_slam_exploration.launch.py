...
def generate_launch_description():
    ...
    enable_exploration_arg = DeclareLaunchArgument(
        'enable_exploration', default_value='true',
        description='Enable automatic exploration'
    )
    ...
    # Path to the exploration launch file
    exploration_launch_path = os.path.join(
    ...
    exploration_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(exploration_launch_path),
        launch_arguments={
                'use_sim_time': LaunchConfiguration('use_sim_time'),
        }.items(),
    ...
    launchDescriptionObject.add_action(enable_exploration_arg)
    launchDescriptionObject.add_action(rviz_node)
    #launchDescriptionObject.add_action(interactive_marker_twist_server_node)
    launchDescriptionObject.add_action(slam_toolbox_launch)
    launchDescriptionObject.add_action(navigation_launch)
    launchDescriptionObject.add_action(exploration_launch)
