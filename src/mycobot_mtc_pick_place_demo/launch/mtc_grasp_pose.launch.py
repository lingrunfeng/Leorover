...
def generate_launch_description():
    ...
    gazebo_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'x': '0.0', 'y': '0.0', 'z': '0.3',  # 抬高0.3m测试向下极限
    ...
    def configure_mtc_node(context):
        ...
        mtc_params = {
            ...
            # 顶抓姿态四元数 - 使用标准垂直向下姿态（绕X轴180度旋转）
            # 之前的手动示教姿态: [0.988, 0.037, 0.021, -0.151] IK无解
            # 现在使用标准垂直向下: 爪子Z轴指向-Z方向
            'top_grasp_orientation': [1.0, 0.0, 0.0, 0.0],  # x, y, z, w - 绕X轴180度
        }
