...
def process_ros2_controllers_config(context):
    ...
    from launch_ros.substitutions import FindPackageShare
    pkg_share = FindPackageShare('mycobot_moveit_config').find('mycobot_moveit_config')
    
    # Define config path using package share directory
    ...
    # Write processed content to the config directory
